...
* Here we train on the inaturalist2021 MINI dataset to use the trained
...
from networks.hypernet import HyperConv2D, HyperLinear, HyperBase, rewindable
...
handler = logging.FileHandler('exp9_4_inaturalist21mini.log', 'w', 'utf-8') # or whatever
...
def main():
    global nlogger
    # Training settings
    parser = argparse.ArgumentParser(description="PyTorch iNaturalist'21 MINI")
    ...
    #dataset1 = datasets.INaturalist('../data', version="2021_train_mini", download=False,
    #                   transform=transform)
    #dataset2 = datasets.INaturalist('../data', version="2021_valid", download=False,
    #    transform=transform)
    #num_classes = 10000
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if correct_test > correct_test_max:
            ...
            if args.save_model:
                torch.save(model.state_dict(), "inaturalist21mini_94cnn.pt")
        if args.only_test:
            break
        scheduler.step()
