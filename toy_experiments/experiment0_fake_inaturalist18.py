...
handler = logging.FileHandler('exp9_1_inaturalist18.log', 'w', 'utf-8') # or whatever
...
def main():
    global nlogger
    # Training settings
    parser = argparse.ArgumentParser(description="PyTorch iNaturalist'18")
    ...
    dataset2 = datasets.INaturalist('../data', version="2021_valid", download=True, transform=transform)
    raise Exception("ONLY TO DOWNLOAD INATURALIST 2021_VALID!")
    dataset1 = datasets.INaturalist('../data', version="2021_train", download=True,
                       transform=transform)
