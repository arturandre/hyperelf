...
- Here we train on the inaturalist2021 network to use the trained
...
handler = logging.FileHandler('exp9_1_inaturalist21.log', 'w', 'utf-8') # or whatever
...
def main():
    global nlogger
    # Training settings
    parser = argparse.ArgumentParser(description="PyTorch iNaturalist'21")
    ...
    dataset1 = datasets.INaturalist('../data', version="2021_train", download=False,
                       transform=transform)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if correct_test > correct_test_max:
            ...
            if args.save_model:
                torch.save(model.state_dict(), "inaturalist18_91cnn.pt")
        if args.only_test:
            break
        scheduler.step()
