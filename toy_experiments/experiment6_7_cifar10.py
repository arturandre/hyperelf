"""
- resnet50 baseline again (not pretrained)
...
handler = logging.FileHandler('exp6_7_cifar10.log', 'w', 'utf-8') # or whatever
...
def main():
    ...
    model = ResNet50(resnet_base, num_channels=3, num_classes=10)
    ...
    if args.save_model:
        torch.save(model.state_dict(), "cifar10_67cnn.pt")
