"""
- resnet50 regularized by early exits
...
from networks.hyper_elyx_resnet50 import ResNet50HyperElyx

root_logger= logging.getLogger()
root_logger.setLevel(logging.DEBUG) # or whatever
handler = logging.FileHandler('exp7_3_cifar100.log', 'w', 'utf-8') # or whatever
...
def main():
    ...
    model = ResNet50HyperElyx(resnet_base, num_channels=3, num_classes=num_classes)
    ...
    if args.save_model:
        torch.save(model.state_dict(), "cifar100_73cnn.pt")
