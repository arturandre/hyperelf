...
handler = logging.FileHandler('exp6_5_cifar10.log', 'w', 'utf-8') # or whatever
...
def main():
    ...
    model = ResNet50Hyper(resnet_base, num_channels=3, num_classes=10)
    ...
    if args.save_model:
        torch.save(model.state_dict(), "cifar10_65cnn.pt")
