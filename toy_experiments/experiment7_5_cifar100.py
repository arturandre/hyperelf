...
nlogger = None
project_tags = ["Baseline", "NoPretrain", "ResolutionResized"]

root_logger= logging.getLogger()
root_logger.setLevel(logging.DEBUG) # or whatever
handler = logging.FileHandler('exp7_5_cifar100.log', 'w', 'utf-8') # or whatever
...
def main():
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if correct_test > correct_test_max:
            ...
            if args.save_model:
                torch.save(model.state_dict(), "cifar100_75cnn.pt")
        scheduler.step()
