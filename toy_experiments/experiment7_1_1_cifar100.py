...
nlogger = None
project_tags = ["Baseline", "ResolutionResized"]

root_logger= logging.getLogger()
root_logger.setLevel(logging.DEBUG) # or whatever
handler = logging.FileHandler('exp7_1_1_cifar100.log', 'w', 'utf-8') # or whatever
...
def main():
    ...
    parser.add_argument('--test-batch-size', type=int, default=125, metavar='N',
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if correct_test > correct_test_max:
            ...
            if args.save_model:
                torch.save(model.state_dict(), "cifar100_711cnn.pt")
        scheduler.step()
