...
handler = logging.FileHandler('exp7_4_cifar100.log', 'w', 'utf-8') # or whatever
...
def main():
    ...
    model = ResNet50Elyx(resnet_base, num_channels=3, num_classes=num_classes)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if correct_test > correct_test_max:
            ...
            if args.save_model:
                torch.save(model.state_dict(), "cifar100_74cnn.pt")
        scheduler.step()
