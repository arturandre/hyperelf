...
- The Classification Network has just HyperConv2D and HyperLinear layers.
...
handler = logging.FileHandler('exp8_7_cifar10.log', 'w', 'utf-8') # or whatever
...
def main():
    ...
    if args.save_model:
        torch.save(model.state_dict(), "cifar100_87cnn.pt")
