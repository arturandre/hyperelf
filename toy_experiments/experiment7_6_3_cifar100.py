...
nlogger = None
project_tags = ["Elyx2Reg", "ElyxTrainAll", "ElyxTest", "ElyxTestNoGt", "ResolutionNormal"]

root_logger= logging.getLogger()
root_logger.setLevel(logging.DEBUG) # or whatever
handler = logging.FileHandler('exp7_6_3_cifar100.log', 'w', 'utf-8') # or whatever
...
def main():
    ...
    model = ResNet50Elyx(resnet_base, num_channels=num_channels, num_classes=num_classes, elyx_head=2)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if correct_test > correct_test_max:
            ...
            if args.save_model:
                torch.save(model.state_dict(), "cifar100_763cnn.pt")
        scheduler.step()
