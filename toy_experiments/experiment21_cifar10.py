...
handler = logging.FileHandler('exp21_cifar10.log', 'w', 'utf-8') # or whatever
...
class HyperNetDynamic(nn.Module):
    def __init__(self, latent_size=64, num_channels=1):
        ...
        self.convt31 = nn.Conv2d(64, 64, 3, 1, padding='same')
        self.convt32 = nn.Conv2d(64, 64, 3, 1, padding='same')
        self.convt33 = nn.Conv2d(64, 64, 3, 1, padding='same')
        self.convt34 = nn.Conv2d(64, 64, 3, 1, padding='same')
...
def main():
    ...
    if args.save_model:
        torch.save(model.state_dict(), "cifar10_21cnn.pt")
