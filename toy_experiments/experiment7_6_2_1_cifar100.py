...
- The network trained on experiment 7_6_2 is used. Only testing. (OnlyTest)
...
handler = logging.FileHandler('exp7_6_2_1_cifar100.log', 'w', 'utf-8') # or whatever
...
def main():
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if correct_test > correct_test_max:
            ...
            if args.save_model:
                torch.save(model.state_dict(), "cifar100_7621cnn.pt")
        if not args.only_test:
            break
        scheduler.step()
