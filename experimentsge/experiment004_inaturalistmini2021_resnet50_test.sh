...
for i in "${!expnames[@]}"; do
    ...
    for j in "${!suffixes[@]}"; do
        ...
        --load-model "/scratch/arturao/hyperelf/outputsge/exp003/exp003_inaturalist2021mini_resnet50.pt" \
        --only-test \
        --log-it-folder "/scratch/arturao/hyperelf/outputsge/${expname}/it" \
