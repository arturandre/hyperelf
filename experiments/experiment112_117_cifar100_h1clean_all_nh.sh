...
expnames=("exp112" "exp113" "exp114" "exp115" "exp116" "exp117" "exp117")
...
for i in "${!expnames[@]}"; do
    ...
    for j in "${!suffixes[@]}"; do
        ...
        --custom-disagreement-csv "/scratch/arturao/hyperelf/outputs/mix_disagreements-e68-74-nh-e100-105-nh/report_disagreements_train.csv" \
