...
# The idea here is to train a second ensemble C2
# based on the the predictions of the first ensemble C1.
# So C1 predicts easy/hard images for the second half of the
# dataset, while C2 does the same for the first half.
...
expnames=("exp106" "exp107" "exp108" "exp109" "exp110" "exp111")
networknames=("resnet50" "efficientnet" "densenet121" "densenet161" "resnet152" "mobilenetv3")
networknameselyx=("ResNet50Elyx" "EfficientNetB0Elyx" "DenseNet121Elyx" "DenseNet161Elyx" "ResNet152Elyx" "MobileNetV3LargeElyx")
datasetnames=("CIFAR100CustomHalfValid")
elyxheads=("None" )
suffixes=("nh")
