...
expnames=("exp190_trees" "exp194_trees" "exp195_trees" "exp196_trees")
networknames=("mobilenetv3" "mobilenetv3" "mobilenetv3" "mobilenetv3")
networknameselyx=("MobileNetV3LargeElyxTrees" "MobileNetV3LargeElyxTrees" "MobileNetV3LargeElyxTrees" "MobileNetV3LargeElyxTrees")
...
pseudodatasets=(
    "None"
    "TreesUnlabed40k,/scratch/arturao/hyperelf/outputs/exp190_treesnh/probs_train_TreesUnlabed40k_outputs.npy"
    "TreesUnlabed40k,/scratch/arturao/hyperelf/outputs/exp194_treesnh/probs_train_TreesUnlabed40k_outputs.npy"
    "TreesUnlabed40k,/scratch/arturao/hyperelf/outputs/exp195_treesnh/probs_train_TreesUnlabed40k_outputs.npy")
