"""
- This experiment is based on the script 9-4
...
nlogger = None
project_tags = [
    "Elyx3Reg", "ElyxTrainAll",
    "ElyxTest", "ElyxTestNoGt",
    "ResolutionResized"]

root_logger= logging.getLogger()
root_logger.setLevel(logging.DEBUG) # or whatever
handler = logging.FileHandler('exp001_cifar100_mobnetv3large.log', 'w', 'utf-8') # or whatever
...
def main():
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if correct_test > correct_test_max:
            ...
            if args.save_model:
                torch.save(model.state_dict(), "exp001_cifar100_mobnetv3large.pt")
        if args.only_test:
            break
        scheduler.step()
