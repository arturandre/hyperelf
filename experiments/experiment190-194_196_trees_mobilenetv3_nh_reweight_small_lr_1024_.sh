...
expnames=("exp196_reweight_small_lr_1024")
...
pseudodatasets=("TreesUnlabed40k,/scratch/arturao/hyperelf/outputs/exp195_reweight_small_lr_1024nh/probs_train_TreesUnlabed40k_outputs.npy")
elyxheads=("None")
suffixes=("nh")
