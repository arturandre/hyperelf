...
expnames=(
    "exp190_reweight_large_lr_gamma_fullres_128"
    "exp194_reweight_large_lr_gamma_fullres_128"
    "exp195_reweight_large_lr_gamma_fullres_128"
    "exp196_reweight_large_lr_gamma_fullres_128")
...
pseudodatasets=(
    "None"
    "TreesUnlabed40k,/scratch/arturao/hyperelf/outputs/exp190_reweight_large_lr_gamma_fullres_128nh/probs_train_TreesUnlabed40k_outputs.npy"
    "TreesUnlabed40k,/scratch/arturao/hyperelf/outputs/exp194_reweight_large_lr_gamma_fullres_128nh/probs_train_TreesUnlabed40k_outputs.npy"
    "TreesUnlabed40k,/scratch/arturao/hyperelf/outputs/exp195_reweight_large_lr_gamma_fullres_128nh/probs_train_TreesUnlabed40k_outputs.npy")
