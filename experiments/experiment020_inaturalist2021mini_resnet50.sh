...
# - This experiment is based on the script 018
...
#   Other possible explanation is that the early exits are somehow
#   interfering, so experiments 20, and 21 will be just as 18 and 19
#   but with pre-trained weights.
#   The results for experiments 20 and 21 should be compared
#   with those from experiments 18, 19, 14 and 16.
