...
expnames=("exp194_fullbackbone" "exp195_fullbackbone" "exp196_fullbackbone")
networknames=("mobilenetv3" "mobilenetv3" "mobilenetv3")
networknameselyx=("MobileNetV3LargeElyx" "MobileNetV3LargeElyx" "MobileNetV3LargeElyx")
datasetnames=("TreesLocatingTest3k" "TreesLocatingTest3k" "TreesLocatingTest3k")
createpseudolabels=("TreesUnlabed40k" "TreesUnlabed40k" "TreesUnlabed40k")
pseudodatasets=(
    "TreesUnlabed40k,/scratch/arturao/hyperelf/outputs/exp190_fullbackbonenh/probs_train_TreesUnlabed40k_outputs.npy"
    "TreesUnlabed40k,/scratch/arturao/hyperelf/outputs/exp194_fullbackbonenh/probs_train_TreesUnlabed40k_outputs.npy"
    "TreesUnlabed40k,/scratch/arturao/hyperelf/outputs/exp195_fullbackbonenh/probs_train_TreesUnlabed40k_outputs.npy")
elyxheads=("None" "None" "None")
suffixes=("nh" "nh" "nh")
