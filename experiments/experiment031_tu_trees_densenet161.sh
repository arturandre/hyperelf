...
--network-name "DenseNet161Elyx" \
--project-tags "TestBatch1,Elyx2Reg,ElyxTrainAll,ElyxTest,ElyxTestNoGt,ResolutionResized" \
--elyx-head "2" \
--dataset-name "TreesUnknownTest" \
--batch-size "1" \
--test-batch-size "1" \
--epochs "20" \
--loss "nll" \
...
--gamma "0.7" \
--log-interval "10" \
--load-model "/scratch/arturao/hyperelf/outputs/exp031/exp031_trees_densenet161.pt" \
--only-test \
