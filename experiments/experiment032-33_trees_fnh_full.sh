...
# Now the experiments fnh (halF no-head) are done and we need
# to train all the networks again based on the predictions
# of the fnh committee for 'unknown' and 'clean' images.

echo -e "\nThis will hold the terminal, press CTRL+Z then type 'bg' and press ENTER.\n"

dbname="trees"

expnames=("exp032" "exp033")
networknames=("densenet" "mobilenetv3")
networknameselyx=("DenseNet121Elyx" "MobileNetV3LargeElyx")
#expnames=("exp036")
