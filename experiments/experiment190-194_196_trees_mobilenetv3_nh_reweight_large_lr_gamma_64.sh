...
expnames=(
    "exp190_reweight_large_lr_gamma_64"
    "exp194_reweight_large_lr_gamma_64"
...
pseudodatasets=(
    "None"
    "TreesUnlabed40k,/scratch/arturao/hyperelf/outputs/exp190_reweight_large_lr_gamma_64nh/probs_train_TreesUnlabed40k_outputs.npy"
