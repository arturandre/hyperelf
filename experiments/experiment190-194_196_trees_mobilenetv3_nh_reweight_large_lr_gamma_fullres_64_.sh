...
networknames=("mobilenetv3" "mobilenetv3")
networknameselyx=("MobileNetV3LargeElyx" "MobileNetV3LargeElyx")
datasetnames=("TreesLocatingTest3k" "TreesLocatingTest3k")
createpseudolabels=("TreesUnlabed40k" "TreesUnlabed40k")
pseudodatasets=(
