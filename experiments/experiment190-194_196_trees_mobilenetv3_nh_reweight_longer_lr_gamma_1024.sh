...
expnames=(
    "exp190_reweight_longer_lr_gamma_1024"
    "exp194_reweight_longer_lr_gamma_1024"
    "exp195_reweight_longer_lr_gamma_1024"
    "exp196_reweight_longer_lr_gamma_1024")
...
pseudodatasets=(
    "None"
    "TreesUnlabed40k,/scratch/arturao/hyperelf/outputs/exp190_reweight_longer_lr_gamma_1024nh/probs_train_TreesUnlabed40k_outputs.npy"
    "TreesUnlabed40k,/scratch/arturao/hyperelf/outputs/exp194_reweight_longer_lr_gamma_1024nh/probs_train_TreesUnlabed40k_outputs.npy"
    "TreesUnlabed40k,/scratch/arturao/hyperelf/outputs/exp195_reweight_longer_lr_gamma_1024nh/probs_train_TreesUnlabed40k_outputs.npy")
