...
# There is no exp078
expnames=("exp075" "exp076" "exp077" "exp079" "exp080" "exp080")
networknames=("resnet152" "efficientnet" "mobilenetv3" "densenet121" "densenet161" "densenet161")
networknameselyx=("ResNet152Elyx" "EfficientNetB0Elyx" "MobileNetV3LargeElyx" "DenseNet121Elyx" "DenseNet161Elyx" "DenseNet161Elyx")
datasetnames=("CIFAR100")
elyxheads=("None" )
suffixes=("nh")
