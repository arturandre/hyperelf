...
expnames=("exp190_reweight_fullres" "exp194_reweight_fullres" "exp195_reweight_fullres" "exp196_reweight_fullres")
...
pseudodatasets=(
    "None"
    "TreesUnlabed40k,/scratch/arturao/hyperelf/outputs/exp190_reweight_fullresnh/probs_train_TreesUnlabed40k_outputs.npy"
    "TreesUnlabed40k,/scratch/arturao/hyperelf/outputs/exp194_reweight_fullresnh/probs_train_TreesUnlabed40k_outputs.npy"
    "TreesUnlabed40k,/scratch/arturao/hyperelf/outputs/exp195_reweight_fullresnh/probs_train_TreesUnlabed40k_outputs.npy")
