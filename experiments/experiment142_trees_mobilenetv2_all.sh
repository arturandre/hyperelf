...
datasetnames=("TreesNoUnknown" "TreesUnknownNegative" "TreesUnknownPositive" "TreesNoUnknown" "TreesUnknownNegative" "TreesUnknownPositive" "TreesUnknownPositive")
elyxheads=("2" "2" "2" "None" "None" "None" "None")
suffixes=("" "un" "up" "nh" "unuh" "upnh" "upnh")
