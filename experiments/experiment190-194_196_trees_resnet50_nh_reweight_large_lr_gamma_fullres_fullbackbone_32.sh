...
expnames=(
    "exp190_resnet50_fullres_fullbackbone_32"
    "exp194_resnet50_fullres_fullbackbone_32"
    "exp195_resnet50_fullres_fullbackbone_32"
    "exp196_resnet50_fullres_fullbackbone_32")
networknames=("resnet50" "resnet50" "resnet50" "resnet50")
networknameselyx=("ResNet50Elyx" "ResNet50Elyx" "ResNet50Elyx" "ResNet50Elyx")
...
pseudodatasets=(
    "None"
    "TreesUnlabed40k,/scratch/arturao/hyperelf/outputs/exp190_resnet50_fullres_fullbackbone_32nh/probs_train_TreesUnlabed40k_outputs.npy"
    "TreesUnlabed40k,/scratch/arturao/hyperelf/outputs/exp194_resnet50_fullres_fullbackbone_32nh/probs_train_TreesUnlabed40k_outputs.npy"
    "TreesUnlabed40k,/scratch/arturao/hyperelf/outputs/exp195_resnet50_fullres_fullbackbone_32nh/probs_train_TreesUnlabed40k_outputs.npy")
