...
expnames=(
    "exp190_customnorm_tophalf_fullbackbone_64"
    "exp194_customnorm_tophalf_fullbackbone_64"
    "exp195_customnorm_tophalf_fullbackbone_64"
    "exp196_customnorm_tophalf_fullbackbone_64")
...
pseudodatasets=(
    "None"
    "TreesUnlabed40k,/scratch/arturao/hyperelf/outputs/exp190_customnorm_tophalf_fullbackbone_64nh/probs_train_TreesUnlabed40k_outputs.npy"
    "TreesUnlabed40k,/scratch/arturao/hyperelf/outputs/exp194_customnorm_tophalf_fullbackbone_64nh/probs_train_TreesUnlabed40k_outputs.npy"
    "TreesUnlabed40k,/scratch/arturao/hyperelf/outputs/exp195_customnorm_tophalf_fullbackbone_64nh/probs_train_TreesUnlabed40k_outputs.npy")
