...
expnames=(
    "exp195_reweight_large_lr_gamma_64"
    "exp196_reweight_large_lr_gamma_64")
...
pseudodatasets=(
    "TreesUnlabed40k,/scratch/arturao/hyperelf/outputs/exp194_reweight_large_lr_gamma_64nh/probs_train_TreesUnlabed40k_outputs.npy"
    "TreesUnlabed40k,/scratch/arturao/hyperelf/outputs/exp195_reweight_large_lr_gamma_64nh/probs_train_TreesUnlabed40k_outputs.npy")
elyxheads=("None" "None")
suffixes=("nh" "nh")
