...
# - This experiment is based on the script 016
# - Here we test on the iNaturalist2021 dataset using the network
#   trained on exp014.
...
--gamma "0.7" \
--log-interval "10" \
--load-model "/scratch/arturao/hyperelf/outputs/exp014/exp014_inaturalist2021mini_resnet152.pt" \
--only-test \
