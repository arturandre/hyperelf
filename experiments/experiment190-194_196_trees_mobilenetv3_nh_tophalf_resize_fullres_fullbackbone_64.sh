...
expnames=(
    "exp190_tophalf_resize_fullres_fullbackbone_64"
    "exp194_tophalf_resize_fullres_fullbackbone_64"
    "exp195_tophalf_resize_fullres_fullbackbone_64"
    "exp196_tophalf_resize_fullres_fullbackbone_64")
...
pseudodatasets=(
    "None"
    "TreesUnlabed40k,/scratch/arturao/hyperelf/outputs/exp190_tophalf_resize_fullres_fullbackbone_64nh/probs_train_TreesUnlabed40k_outputs.npy"
    "TreesUnlabed40k,/scratch/arturao/hyperelf/outputs/exp194_tophalf_resize_fullres_fullbackbone_64nh/probs_train_TreesUnlabed40k_outputs.npy"
    "TreesUnlabed40k,/scratch/arturao/hyperelf/outputs/exp195_tophalf_resize_fullres_fullbackbone_64nh/probs_train_TreesUnlabed40k_outputs.npy")
