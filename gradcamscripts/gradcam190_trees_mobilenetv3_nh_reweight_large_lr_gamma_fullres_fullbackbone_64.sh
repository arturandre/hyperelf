...
expnames=("exp190_reweight_large_lr_gamma_fullres_fullbackbone_64")
...
for i in "${!expnames[@]}"; do
    ...
    --load-model "/scratch/arturao/hyperelf/outputs/exp190_reweight_large_lr_gamma_fullres_fullbackbone_64nh/exp190_reweight_large_lr_gamma_fullres_fullbackbone_64nh_trees_mobilenetv3.pt" \
